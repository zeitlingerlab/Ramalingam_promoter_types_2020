...
options(knitr.figure_dir = "figure_4b_accessibility_single_region_tissue_examples")
...
bw_files<-read.table("data/figure4b_single_gene_tissue_data.csv",header=TRUE,sep=",")

regions.df<-read.table("data/figure4b_single_gene_tissue_region.csv",header=TRUE,sep=",")
regions.df
