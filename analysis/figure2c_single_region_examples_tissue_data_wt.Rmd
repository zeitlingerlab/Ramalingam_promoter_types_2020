...
options(knitr.figure_dir = "figure_2c_single_region_tissue_examples")
...
# Plot Single region examples

``` {r header_child, child="child_docs/header_child.Rmd"}
```

``` {r plot_from_bigwigs, dev=c("png","pdf"),fig.width=12,fig.height=12}


bw_files<-read.table("data/figure2c_single_gene_tissue_data.csv",header=TRUE,sep=",")

regions.df<-read.table("data/figure2c_single_gene_tissue_region.csv",header=TRUE,sep=",")
regions.df
