...
if(!file.exists(figure_path("go_results.xls"))){go_term_analysis()}
```
...
go_term_analysis_tata_paused<-function(){
...
write.table(go_results, file=figure_path("Dataset_EV9_go_results_tata_paused.xls"), quote=FALSE, row.names=FALSE, col.names=TRUE, sep="\t")
...
if(!file.exists(figure_path("Dataset_EV9_go_results_tata_paused.xls"))){go_term_analysis_tata_paused()}
